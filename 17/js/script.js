        ...
        if (backCanvas.getContext) {
          ...
          const globalOpacityAnimationTick = async (globalProgress) => {
            if (globalProgress >= 0 && backAnimation.indexOf(`backO`) === -1) {
              ...
              _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].easing(backOpacityAnimationTick(0, 1), 1000, Object(_helpers_cubicBezier__WEBPACK_IMPORTED_MODULE_1__["BezierEasing"])(0.00, 0.0, 0.58, 1.0));
          ...
          backImg.onload = () => {
            ...
            _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].duration(globalOpacityAnimationTick, 2000);
          };
        ...
        if (planeCanvas.getContext) {
          ...
          const globalOpacityAnimationTick = (globalProgress) => {
            if (globalProgress >= 0 && planeAnimation.indexOf(`planeO`) === -1) {
              ...
              _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].easing(planeOpacityAnimationTick(0, 1), 1000, Object(_helpers_cubicBezier__WEBPACK_IMPORTED_MODULE_1__["BezierEasing"])(0.00, 0.0, 0.58, 1.0));
            }
            drawPlaneCanvas();
          };
          ...
          planeImg.onload = () => {
            ...
            _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].duration(globalOpacityAnimationTick, 1000);
            _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].duration(globalTransformingAnimationTick, 3000);
        ...
        if (flakesCanvas.getContext) {
          ...
          const globalOpacityAnimationTick = async (globalProgress) => {
            if (globalProgress >= 0 && flakesAnimation.indexOf(`flakeO`) === -1) {
              ...
              _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].easing(flakesOpacityAnimationTick(0, 1), 1000, Object(_helpers_cubicBezier__WEBPACK_IMPORTED_MODULE_1__["BezierEasing"])(0.00, 0.0, 0.58, 1.0));
            }
            drawFlakesCanvas();
          };
        ...
        if (treesCanvas.getContext) {
          ...
          const globalOpacityAnimationTick = async (globalProgress) => {
            if (globalProgress >= 0 && flakesAnimation.indexOf(`treeO`) === -1) {
              ...
              _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].easing(treesOpacityAnimationTick(0, 1), 2000, Object(_helpers_cubicBezier__WEBPACK_IMPORTED_MODULE_1__["BezierEasing"])(0.00, 0.0, 0.58, 1.0));
          ...
          images.forEach((image) => {
            image.onload = () => {
              ...
              if (imagesLoadCounter === images.length) {
                ...
                _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].duration(globalOpacityAnimationTick, 2500);
              }
            };
          });
        ...
        if (calfCanvas.getContext) {
          ...
          const globalCalfTransformAnimationTick = (globalProgress) => {
            if (globalProgress >= 0 && calfAnimation.indexOf(`calfT`) === -1) {
              ...
              _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].easing(calfTranslateYAnimationTick(calfTranslateY, 0), 500, Object(_helpers_cubicBezier__WEBPACK_IMPORTED_MODULE_1__["BezierEasing"])(0.00, 0.0, 0.58, 1.0));
            }
            drawCalfCanvas();
          };
          ...
          images.forEach((image) => {
            image.onload = async () => {
              ...
              if (imagesLoadCounter === images.length) {
                ...
                await _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].duration(globalCalfTransformAnimationTick, 500);
                await _helpers_animate_functions__WEBPACK_IMPORTED_MODULE_0__["default"].duration(globalCalfBounceAnimationTick, 4500);
              }
            };
          });
