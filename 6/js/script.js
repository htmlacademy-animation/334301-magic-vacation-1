...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (this.activeScreen === INTRO_SCREEN_ID) {
      _intro__WEBPACK_IMPORTED_MODULE_1__["default"].forEach((elememt) => elememt.runAnimation());
    } else {
      _intro__WEBPACK_IMPORTED_MODULE_1__["default"].forEach((elememt) => elememt.destroyAnimation());
    }
  }
...
const introTitle = new _animated_text__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.intro__title`), 500);
const introDate = new _animated_text__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.intro__date`), 500);
